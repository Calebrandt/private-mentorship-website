...
(function () {
  ...
  async function sendFinancialEmail({ docType, docId, docNumber, to, cc, bcc, subject, body, filename, pdfBase64, meta }) {
    ...
    const { data, error } = await sb().functions.invoke('email-financial-document', {
      body: { docType, docId, docNumber, to, cc, bcc, subject, body, filename, pdfBase64, meta },
    });
